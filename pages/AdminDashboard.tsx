          ...
          <div className="space-y-8">
            ...
            <div className="bg-slate-900 p-12 rounded-[3rem] text-white shadow-2xl relative overflow-hidden">
               ...
               <div className="flex gap-4">
                  <a  href="https://docs.google.com/spreadsheets/d/1KjFD4Pjq1D6Z8gONl1m5dCJk3FBP48U_YvU-PYCeDw4/edit" target="_blank" rel="noreferrer" className="px-8 py-4 bg-white text-slate-900 rounded-2xl font-bold hover:bg-slate-100 transition shadow-lg flex items-center gap-3">
                    Buka Spreadsheet
